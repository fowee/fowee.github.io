    ...
    PSV.setPanorama('./panorama/fx.jpg', {
        ...
        .then(function () {
            ...
            PSV.addMarker({
                id: 'fx_001',
                name: 'The path',
                content: '<iframe src="../zp/ffx_001.html" style="height:100%;width:100%">',
            ...
            PSV.addMarker({
                id: 'fx_002',
                name: 'The path',
                content: '<iframe src="../zp/ffx_002.html" style="height:100%;width:100%">',
            ...
            PSV.addMarker({
                id: 'fx_003',
                name: 'The path',
                content: '<iframe src="../zp/ffx_003.html" style="height:100%;width:100%">',
            ...
            PSV.addMarker({
                id: 'fx_004',
                name: 'The path',
                content: '<iframe src="../zp/ffx_004.html" style="height:100%;width:100%">',
                latitude: -5 * Math.PI / 64,
            ...
            PSV.addMarker({
                id: 'fx_010',
                name: 'The path',
                content: '<iframe src="../zp/ffx_010.html" style="height:100%;width:100%">',
            ...
            PSV.addMarker({
                id: 'fx_011',
                name: 'The path',
                content: '<iframe src="../zp/ffx_011.html" style="height:100%;width:100%">',
            ...
            PSV.addMarker({
                id: 'fx_012',
                name: 'The path',
                content: '<iframe src="../zp/ffx_012.html" style="height:100%;width:100%">',
            ...
            PSV.addMarker({
                id: 'fx_013',
                name: 'The path',
                content: '<iframe src="../zp/ffx_013.html" style="height:100%;width:100%">',
                latitude: -11 * Math.PI / 128,
            ...
            PSV.addMarker({
                id: 'fx_014',
                name: 'The path',
                content: '<iframe src="../zp/ffx_014.html" style="height:100%;width:100%">',
                latitude: -7 * Math.PI / 64,
    ...
    PSV.setPanorama('./panorama/sh.jpg', {
        ...
        .then(function () {
            ...
            PSV.addMarker({
                ...
                content: '<iframe src="../zp/fsh_001.html" style="height:100%;width:100%">',
            ...
            PSV.addMarker({
                ...
                name: 'The path',
                // content: document.getElementById('sh_001').innerHTML,  
                content: '<iframe src="../zp/fsh_002.html" style="height:100%;width:100%">',
                latitude: 2 * Math.PI / 16,
            ...
            PSV.addMarker({
                ...
                name: 'The path',
                // content: document.getElementById('sh_001').innerHTML,  
                content: '<iframe src="../zp/fsh_003.html" style="height:100%;width:100%">',
            ...
            PSV.addMarker({
                ...
                name: 'The path',
                // content: document.getElementById('sh_001').innerHTML,  
                content: '<iframe src="../zp/fsh_004.html" style="height:100%;width:100%">',
                latitude: 2 * Math.PI / 16,
